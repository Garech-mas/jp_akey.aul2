...
AviUtl ExEdit2 beta21 までの項目に対応しています。
...
## 注意点
リリース時最新版（beta21）では、言語ファイルを変更すると**ショートカットキーの設定が失われます。**
...
どうしてもアクセスキーを追加したい場合、`日本語(アクセスキー付き).aul2`をテキストエディタで開き、13行目～21行目のコメントアウトを外してください。
